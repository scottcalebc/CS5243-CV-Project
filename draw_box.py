...
# Taken from https://github.com/waittim/draw-YOLO-box
import cv2
import os
import random

# Config the global variables 
LABEL_FOLDER = './datasets/EikelboomSavanna/train/labels/'  # Put the label files in this folder. 检测结果存放文件夹labels路径
RAW_IMAGE_FOLDER = './datasets/EikelboomSavanna/train/images/'  # Put the original images without boxes in this folder. 检查图片存放文件夹raw_images路径
OUTPUT_IMAGE_FOLDER = './datasets/EikelboomSavanna/train/labeled_images/'  # The output images would be saved to this folder. 保存图片文件夹save_image路径
IMAGE_NAME_LIST_PATH = './name_list.txt'  # The file name of images will be saved into this text file. 内含有检测图片名的txt文件路径
CLASS_PATH = './datasets/EikelboomSavanna/classes.txt' # Put the class names in this text file.
